...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white mt-12">
      <div className="container mx-auto px-4 py-10 flex flex-col md:flex-row justify-between items-center md:items-start gap-6">
        <div className="text-center md:text-left">
          ...
          <div className="mt-6 flex justify-center md:justify-start space-x-6 text-gray-300">
            <a
